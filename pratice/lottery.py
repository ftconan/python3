...
if __name__ == '__main__':
    ...
    point_list = [8, 11, 16, 8, 13, 10, 15, 10, 9, 12, 9, 13, 8, 6, 13, 6, 16, 11, 16, 8, 13, 13, 10, 15, 10, 9, 12, 9,
                  13, 8, 6, 13, 6, 16, 11, 10, 7, 12, 9, 7, 8, 10, 7, 7, 7, 15, 15, 11, 17, 7, 17]
    ...
    print([(13, 12), (8, 8), (10, 10), (9, 10), (12, 8), (7, 6), (15, 4), (6, 4), (16, 4), (4, 2), (17, 2)])
    print(12 * 2 + 10 * 2 + 8 * 2 + 6 * 2 + 4 * 2 + 2 * 2)
